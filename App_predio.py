...
Compatibilidade """PWA de vistoria e auditoria para engenharia civil.
...
def gerar_pdf(
    ...
    data_conferencia_pdf = data_conferencia or datetime.now(
    ...
    def desenhar_titulo_e_legenda() -> float:
        ...
        pdf.cell(
            277,
            4.5,
            _texto_pdf(f"Data de Conferência: {data_conferencia_pdf}"),
            align="C",
            new_x=XPos.LMARGIN,
            new_y=YPos.NEXT,
        )
