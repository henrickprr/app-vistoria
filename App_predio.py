...
def main(page: ft.Page):
    ...
    def abrir_tela_obs_lote(obra):
        ...
        botao_aplicar = ft.Container(
            content=ft.Row([ft.Icon(ft.Icons.DONE_ALL, color=ft.Colors.WHITE), ft.Text("APLICAR OBSERVAÇÕES", color=ft.Colors.WHITE, weight="bold", size=15)], alignment="center"),
        ...
        layout = ft.Column([
            ...
            campo_obs,
            ft.Divider(),
            ft.Row([ft.Text("SELECIONE OS APARTAMENTOS:", size=12, weight="bold", color=ft.Colors.GREY_600), btn_selecionar_todos], alignment="spaceBetween"),
            ft.Container(content=grid_aptos, expand=True)
        ], expand=True)
